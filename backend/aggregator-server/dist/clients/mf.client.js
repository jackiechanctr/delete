...
const summaryBreaker = new CircuitBreaker(async (investorRef) => {
    ...
    const txTotal = txRes.data.data.reduce((s, t) => s + (t.amount ?? 0), 0);
...
export const mfClient = {
    async getPortfolioSummary(investorRef) {
